     ...
     //   public Texture2D mipmapSourceTex;
        ...
        public Texture2D GenerateMipmap(in Texture2D sourceTex,bool isNormalMap=false)
        {
         //   Texture2D sourceTex1 = sourceTex;
            ...
            this.terrainMip1 = new RenderTarget2D(device, sourceTex.Width/2, sourceTex.Height / 2,true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip2 = new RenderTarget2D(device, terrainMip1.Width/2, terrainMip1.Height/2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip3 = new RenderTarget2D(device, terrainMip2.Width / 2, terrainMip2.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip4 = new RenderTarget2D(device, terrainMip3.Width / 2, terrainMip3.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip5 = new RenderTarget2D(device, terrainMip4.Width / 2, terrainMip4.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip6 = new RenderTarget2D(device, terrainMip5.Width / 2, terrainMip5.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip7 = new RenderTarget2D(device, terrainMip6.Width / 2, terrainMip6.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip8 = new RenderTarget2D(device, terrainMip7.Width / 2, terrainMip7.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip9 = new RenderTarget2D(device, terrainMip8.Width / 2, terrainMip8.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
            this.terrainMip10 = new RenderTarget2D(device, terrainMip9.Width / 2, terrainMip9.Height / 2, true, sourceTex.Format, DepthFormat.Depth16);
        ...
        //    RenderQuad(device, terrainMip7, textureCopyEffect);
          ...
          //  RenderQuad(device, terrainMip8, textureCopyEffect);
            ...
            sourceTex.GetData<Color>(0, null, atlasMip0, 0, sourceTex.Width * sourceTex.Height);
           
            terrainMip1.GetData<Color>(0, null, atlasMip1, 0, atlasMip1.Length);
            terrainMip2.GetData<Color>(0, null, atlasMip2, 0, atlasMip2.Length);
            terrainMip3.GetData<Color>(0, null, atlasMip3, 0, atlasMip3.Length);
            terrainMip4.GetData<Color>(0, null, atlasMip4, 0, atlasMip4.Length);
            terrainMip5.GetData<Color>(0, null, atlasMip5, 0, atlasMip5.Length);
            terrainMip6.GetData<Color>(0, null, atlasMip6, 0, atlasMip6.Length);
            terrainMip7.GetData<Color>(0, null, atlasMip7, 0, atlasMip7.Length);
            terrainMip8.GetData<Color>(0, null, atlasMip8, 0, atlasMip8.Length);
            terrainMip9.GetData<Color>(0, null, atlasMip9, 0, atlasMip9.Length);
            terrainMip10.GetData<Color>(0, null, atlasMip10, 0, atlasMip10.Length);

            mipmapSourceTex.SetData<Color>(0, 0, null, atlasMip0, 0, mipmapSourceTex.Width * mipmapSourceTex.Height);
            mipmapSourceTex.SetData<Color>(1, 0, null, atlasMip1, 0, mipmapSourceTex.Width / 2 * mipmapSourceTex.Height / 2);
            mipmapSourceTex.SetData<Color>(2, 0, null, atlasMip2, 0, mipmapSourceTex.Width / 4 * mipmapSourceTex.Height / 4);
            mipmapSourceTex.SetData<Color>(3, 0, null, atlasMip3, 0, mipmapSourceTex.Width / 8 * mipmapSourceTex.Height / 8);
            mipmapSourceTex.SetData<Color>(4, 0, null, atlasMip4, 0, mipmapSourceTex.Width / 16 * mipmapSourceTex.Height / 16);
            mipmapSourceTex.SetData<Color>(5, 0, null, atlasMip5, 0, mipmapSourceTex.Width / 32 * mipmapSourceTex.Height / 32);
            mipmapSourceTex.SetData<Color>(6, 0, null, atlasMip6, 0, mipmapSourceTex.Width / 64 * mipmapSourceTex.Height / 64);
            mipmapSourceTex.SetData<Color>(7, 0, null, atlasMip7, 0, mipmapSourceTex.Width / 128 * mipmapSourceTex.Height / 128);
            mipmapSourceTex.SetData<Color>(8, 0, null, atlasMip8, 0, mipmapSourceTex.Width / 256 * mipmapSourceTex.Height / 256);
            mipmapSourceTex.SetData<Color>(9, 0, null, atlasMip9, 0, mipmapSourceTex.Width / 512 * mipmapSourceTex.Height / 512);
            mipmapSourceTex.SetData<Color>(10, 0, null, atlasMip10, 0, mipmapSourceTex.Width / 1024 * mipmapSourceTex.Height / 1024);

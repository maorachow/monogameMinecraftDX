...
namespace monogameMinecraftDX
{
    ...
    public struct BlockInfoJsonData
    {
        ...
        public static BlockInfoJsonData FromBlockInfo(BlockInfo info)
        {
            ...
            {
                BlockInfo ret = new BlockInfo(Vector2Data.ToVector2List(info.uvCorners), Vector2Data.ToVector2List(info.uvSizes), info.shape);
                return ret;
    ...
    public class BlockResourcesManager
    {
        ...
        //    Dictionary<int, List<Vector2Data>> blockInfoData = JsonSerializer.Deserialize<Dictionary<int, List<Vector2Data>>>(blockInfoDataString);
                Dictionary<int,BlockInfoJsonData> blockInfoDataNew = JsonSerializer.Deserialize<Dictionary<int, BlockInfoJsonData>>(blockInfoDataString);

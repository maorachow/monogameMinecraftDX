...
namespace monogameMinecraftShared.Updateables
{
    public class EntityBeh : IMovableCollider
    {
        ...
        public EntityBeh(Vector3 position, float rotationX, float rotationY, float rotationZ, int typeID, string entityID, float entityHealth, bool isEntityHurt, MinecraftGameBase game)
        {
        ...
        public void SaveSingleEntity()
        {
            ...
            EntityData tmpData = new EntityData(typeID, position.X, position.Y + entitySize.Y / 2f, position.Z, rotationX, rotationY, rotationZ, entityID, entityHealth, VoxelWorld.currentWorld.worldID);

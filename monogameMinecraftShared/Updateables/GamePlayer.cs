...
namespace monogameMinecraftShared.Updateables
{
    public class GamePlayer : IMovableCollider,IGamePlayer
    {
        ...
        public void PlayerTryTeleportToEnderWorld(MinecraftGameBase game, float deltaTime)
        {
        ...
        public void UpdatePlayer(MinecraftGameBase game, float deltaTime)
        {
            isChunkNeededUpdate = true;
            UpdatePlayerChunk();
        ...
        public void PlayerBlockOnFootChanged(MinecraftGameBase game, float deltaTime)
        {
        ...
        public void GetBlockOnFoot(MinecraftGameBase game, float deltaTime)
        {

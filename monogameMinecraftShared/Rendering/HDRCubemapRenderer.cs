...
namespace monogameMinecraftShared.Rendering
{
    public class HDRCubemapRenderer
    {
        ...
        public (RenderTargetCube resultCubemap,
            RenderTargetCube resultIrradianceCubemap,
            RenderTargetCube resultSpecularCubemapMip0,
            RenderTargetCube resultSpecularCubemapMip1,
            RenderTargetCube resultSpecularCubemapMip2,
            RenderTargetCube resultSpecularCubemapMip3,
            RenderTargetCube resultSpecularCubemapMip4) resultCubeCollection, resultCubeCollectionNight;



        public HDRCubemapRenderer(GraphicsDevice device, Effect cubemapEffect, Texture2D hdriTex, Effect cubemapIrradianceEffect, Effect cubemapPrefilterEffect, Texture2D hdriTexNight)
        {
            this.device = device;
            ...
            resultCubeCollection.resultCubemap = new RenderTargetCube(device, 512, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollection.resultSpecularCubemapMip0 = new RenderTargetCube(device, 256, true, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollection.resultSpecularCubemapMip1 = new RenderTargetCube(device, 128, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollection.resultSpecularCubemapMip2 = new RenderTargetCube(device, 64, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollection.resultSpecularCubemapMip3 = new RenderTargetCube(device, 32, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollection.resultSpecularCubemapMip4 = new RenderTargetCube(device, 16, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollection.resultIrradianceCubemap = new RenderTargetCube(device, 512, false, SurfaceFormat.Vector4, DepthFormat.Depth24);

            resultCubeCollectionNight.resultCubemap = new RenderTargetCube(device, 512, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollectionNight.resultSpecularCubemapMip0 = new RenderTargetCube(device, 256, true, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollectionNight.resultSpecularCubemapMip1 = new RenderTargetCube(device, 128, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollectionNight.resultSpecularCubemapMip2 = new RenderTargetCube(device, 64, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollectionNight.resultSpecularCubemapMip3 = new RenderTargetCube(device, 32, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollectionNight.resultSpecularCubemapMip4 = new RenderTargetCube(device, 16, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
            resultCubeCollectionNight.resultIrradianceCubemap = new RenderTargetCube(device, 512, false, SurfaceFormat.Vector4, DepthFormat.Depth24);
        ...
        public void Render((RenderTargetCube resultCubemap,
            RenderTargetCube resultIrradianceCubemap,
            RenderTargetCube resultSpecularCubemapMip0,
            RenderTargetCube resultSpecularCubemapMip1,
            RenderTargetCube resultSpecularCubemapMip2,
            RenderTargetCube resultSpecularCubemapMip3,
            RenderTargetCube resultSpecularCubemapMip4) targetColl, int renderSourceTexID = 0)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                device.SetRenderTarget(targetColl.resultCubemap, CubeMapFace.PositiveX + i);
